...
interface Cliente {
  ...
  const Clientes: Cliente[] = [
    ...
    nitCliente:'Digitar NIT',minimoKgUrbano:20, promedioKgNacional:0, minimoKgNacional:15,
    ...
    nitCliente:'Digitar NIT', minimoKgUrbano:0, promedioKgNacional:0, minimoKgNacional:0,
    ...
    tipo:'gerente', nitCliente:'Digitar NIT', minimoKgUrbano:0, promedioKgNacional:0, minimoKgNacional:0,
    promedioKgUrbano:0, descuento:0, anoVigencia:2024, descuentoNacional:0,
    cobroMinDespachoUrbano:0,cobroMinCajaUrbano:0, tarifaIntegralUrbano:0,
    cobroMinDespachoNacional:0, cobroMinCajaNacional:0,tarifaIntegralNacional:0,
    addValorem:0,diasCartera:60},
    ...
    tipo:'comercial', nitCliente:'Digitar NIT', minimoKgUrbano:0, promedioKgNacional:0, minimoKgNacional:0,
    promedioKgUrbano:0, descuento:0, anoVigencia:2024, descuentoNacional:0,
    cobroMinDespachoUrbano:0,cobroMinCajaUrbano:0, tarifaIntegralUrbano:0,
    cobroMinDespachoNacional:0, cobroMinCajaNacional:0,tarifaIntegralNacional:0,
    addValorem:0,diasCartera:60},
