...
import firmaJorge from '../imagenes/FirmaJorgeC.png';
import firmaMarcela from '../imagenes/FirmaMarcela.png';
...
const ExportarCotizacion: React.FC  = () => {
  ...
  const generateTable = (descuento: number) => {
    ...
    'RIONEGRO - ANTIOQUIA', 'PALMIRA - VALLE DEL CAUCA', 'JAMUNDI - VALLE DEL CAUCA', 'JAMUNDI - VALLE DEL CAUCA','YUMBO - VALLE DEL CAUCA',
...
<View style={estilosParaExportar.footerImage}>
  {clave === 'js2024' ? (
    ...
    <>
      <Image src={firmaJorge} style={estilosParaExportar.firma} />
      <Image src={firmaCarlos} style={estilosParaExportar.firma} />
    </>
  ) : clave === 'mg2024' ? (
    <>
      <Image src={firmaMarcela} style={estilosParaExportar.firma} />
      <Image src={firmaCarlos} style={estilosParaExportar.firma} />
    </>
  ) : clave === 'nv2024' ? (
    <>
